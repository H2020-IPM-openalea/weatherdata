...
- A `PDF <../latex/weather.pdf>`_ version of |weather| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:alinea:weather:weather>`__ wiki.
